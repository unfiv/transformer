...
namespace transformer
{
	...
	void MeshSkinner::skin(
			const Mesh& source_mesh, const BonePoseData& bone_pose_data, Profiler& profiler, Mesh& result_mesh) const
	{
		...
		{
			precomputed_skinning_matrixes[bone_index]
